...
EdgeListFile = open('/Users/emywli/Desktop/Research/Sources/GCv14_EdgeList_test.csv','r')
...
cycles4 = open('/Users/emywli/Desktop/Research/GCv14_4cyclessimple.csv','r')
data4 = cycles4.read()
lines4 = data4.split('\n')
cycles4.close()
...
for location in locations: 
    filename = '/Users/emywli/Desktop/Research/L1 Noon Samples/' + str(location[0]) + '_L1_20180702_' + str(location[1]) + '.txt'
